...
/*
Definition of AppColours class, containing all the user defined colours,
...
/*
Definition of AppLAF class, which inherits from juce::LookAndFeel_V4, meaning
that it serves as a specific implementation of its virtual member functions.
Each of them is meant to custom the style of a built-in JUCE component.
*/
